          ...
          <TabsContent value="profil">
            <div className="grid items-center gap-16 md:grid-cols-2">
              ...
              >
                ...
                <div className="absolute -bottom-5 -left-5 z-0 h-32 w-32 border-8 border-yellow-400 opacity-20"></div>{" "}
                <div className="absolute -right-5 -top-5 z-0 h-32 w-32 border-8 border-yellow-400 opacity-20"></div>
                <img
              ...
              >
                <p className="text-justify text-base text-gray-700">
                  <strong>kami</strong> adalah perusahaan yang bergerak di
                  bidang general supplier, dengan spesialisasi pada pengadaan
                  material dan jasa pemeliharaan alat berat. Kami menyediakan
                  berbagai kebutuhan industri seperti material teknik,
                  fabrication & machining, serta layanan maintenance & repair.
                </p>

                <p className="text-justify text-base text-gray-700">
                  Sejak berdiri, kami telah melayani berbagai sektor seperti
                  pembangkitan, konstruksi, manufaktur, dan infrastruktur di
                  Indonesia. Komitmen kami adalah memberikan solusi tepat,
                  cepat, dan berkualitas untuk mendukung kelancaran operasional
                  industri mitra kami.
                </p>
